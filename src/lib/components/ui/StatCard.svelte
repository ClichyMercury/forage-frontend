...
<div class="bg-white rounded-2xl p-5 border border-slate-100 hover:border-slate-200 hover:shadow-md transition-all">
  <div class="flex items-start justify-between">
    <div class="flex-1 min-w-0">
      ...
      <p class="text-2xl font-bold text-slate-900 mt-1.5 leading-none">{value}</p>
      {#if subtitle}
    ...
    <div class="w-11 h-11 rounded-xl {c.bg} border {c.border} flex items-center justify-center shrink-0 ml-3">
